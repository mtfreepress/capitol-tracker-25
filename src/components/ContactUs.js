...
const ContactUs = () => {
    return (
        <div css={containerCss}>
            ...
            <p>
                The information presented here is collected from a variety of sources including the Montana Legislature’s <a href="https://leg.mt.gov/legislator-information/">public roster</a> and its official bill-tracking system, the <a href="http://laws.leg.mt.gov/legprd/law0203w$.startup?P_SESS=20211">Legislative Automated Workflow System</a>, or LAWS. Reporting and web design was done primarily by MTFP Deputy Editor Eric Dietrich. Please contact him at <a href="mailto:edietrich@montanafreepress.org">edietrich@montanafreepress.org</a> with bug reports, questions or suggestions.
            </p>

            <p>
                Think there's a potential news story to be done about a bill or lawmaker you see here? Tell us at <a href="mailto:tips@montanafreepress.org">tips@montanafreepress.org</a>.
            </p>
        </div>
    );
};
